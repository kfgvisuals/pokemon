...
class PokemonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pokemon" do
    assert_difference('Pokemon.count') do
      post pokemons_url, params: { pokemon: { image: @pokemon.image, level: @pokemon.level, name: @pokemon.name } }
    end
  ...
  test "should update pokemon" do
    patch pokemon_url(@pokemon), params: { pokemon: { image: @pokemon.image, level: @pokemon.level, name: @pokemon.name } }
